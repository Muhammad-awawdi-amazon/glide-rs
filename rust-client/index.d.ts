 ...
 * Should NOT be used in production.
 */
export declare function createLeakedMap(map: Record<string, string>): [number, number]
/**
 * This function is for tests that require a value allocated on the heap.
 * Should NOT be used in production.
 */
export declare function createLeakedArray(array: Array<string>): [number, number]
/**
 * This function is for tests that require a value allocated on the heap.
 * Should NOT be used in production.
 */
export declare function createLeakedAttribute(message: string, attribute: Record<string, string>): [number, number]
/**
 * This function is for tests that require a value allocated on the heap.
 * Should NOT be used in production.
 */
